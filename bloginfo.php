<?php
    ...
    $query_result = $application -> all_Published_BlogInfo();
      ...
      <div class="row">
       <?php while($blog_info = mysqli_fetch_assoc($query_result)) {?>
        <div class="col-md-8">
          ...
          <small><?php echo $blog_info['author_name']; ?></small>
          <br><br>
          <img src="admin/<?php echo $blog_info['blog_image']; ?>" alt="" class="img-responsive">
          <p><?php echo mb_substr($blog_info['blog_description'],0, 200) ?></p>
